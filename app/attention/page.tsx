            ...
            <div className="at-pc-box">
                ...
                <div className="at_main">
                    <div className="yoyaku">
                        ...
                        <p>予約方法：本校ホームページより神奈川県の電子申請システムe-kanagawaを用いて事前予約をしていただきます。</p>
                        <p>詳しくは右上の「お申し込み」をタップ！</p>
                    </div>
                    <div className="payment">
                        ...
                        <p> 模擬店等での販売は電子決済で行います。使用可能な電子マネーブランドは下の添付画像をご覧ください。掲載されているブランド以外での支払いはできません。
                            ...
                            また、本校近隣にはコンビニ・ＡＴＭがありません。充分にチャージしてからご来場ください。</p>
                        <p> ※食堂及び休憩所は現金にて販売いたします。休憩所は午後に飲料を販売します。</p>
                        ...
                        <h2>〈諸注意〉</h2>
                        <ol className="list">
                            <li>本校は一足制ですので、上履きのご用意は必要ありません。ただし革靴、ハイヒールではグラウンドに入れませんのでご注意ください。また、体育館ステージをご覧の方は上履き（体育館履き、スリッパなど）が必要です。</li>
                            <li>自家用車でのご来校はご遠慮ください。校内及び周辺の道路は全面駐車禁止です。昨年度は三ツ沢公園の駐車場利用について管理事務所より注意の電話がありました。公共交通機関を利用しての来場にご協力お願い申し上げます。</li>
                            <li>バスを利用する際は混雑が予想されるため、バス停「三ツ沢総合グランド入口」も併せてご利用ください。</li>
                            <li>校内は全面禁煙です。</li>
                        </ol>
                    </div>
                    <div className="guide">
