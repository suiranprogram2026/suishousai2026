...
export const announceItems: AnnounceItem[] = [
    { id: 7, title: "屋外ステージ", detail: "まだ空模様が読めません。屋外ステージのタイムテーブルはまだ変動の可能性があります。ご了承ください。", date:"2026.6.28"},
    ...
    { id: 5, title: "企画情報・マップ公開！", detail: "本日の屋外ステージは中止となります。屋内ステージは予定通り開催します。また、明日の屋外ステージの詳細については追って連絡いたします。", date:"2026.06.27" }, 
