...
//{ id: 1, img: 'event_1.jpg←数字はidと一致', title: '企画名', reading: "企画名読み方", category: 上参照, floor: 階（マップ用）, class: "団体", room: マップのroomid, location: 開催教室（roomidでmapsvgと連動して、こっちをポップアップに表示する。},
    ...
    { id: 52, img: 'event_52.png', title: 'beyond borde', category: "exhibition", floor: 4, class: "国際交流委員会", location:"1-5前", room:"room-1-5-front"},
    { id: 53, img: 'event_53.png', title: 'ベーゴマ体験',reading:"べーごまたいけん", category: "play", floor: 3, class: "有志",location:"書道室", room:"syodou-back"},
    ...
    { id: 56, img: 'event_56.jpg', title: 'アジアンスイーツパラダイス', reading: "あじあんすいーつぱらだいす", category: "food", floor: 1, class: "定時制",location:"3-5", room:"room-3-5"},
    { id: 57, img: 'event_57.png', title: '定時制 多文化共生（イラストなし！！）', reading: "ていじせい たぶんかきょうせい", category: "exhibition", floor: 1, class: "定時制",location:"3-6後ろ", room:"room-3-6-back"},
    ...
    //ステージ
    { id: 59, img: 'event_59.jpg', title: '夢走舞踊', reading: "むそうぶよう", category: "stage", class: "ダンス部", floor:1, room:"gym_stage", location:"体育館"},
    { id: 60, img: 'event_60.jpg', title: '風林火山', reading:"ふうりんかざん", category: "stage", class: "バスケ部", floor:1, room:"outdoor_stage", location:"野外ステージ"},
    { id: 61, img: 'event_61.jpg', title: 'ビンゴ大会', category: "stage", class: "生徒会執行部", floor:1, room:"outdoore_stage", location:"野外ステージ"},
    ...
    { id: 63, img: 'event_63.jpg', title: 'スパゲティ', category: "stage", class: "吹奏楽部", floor:1, room:"outdoor_stage", location:"野外ステージ"},
    { id: 64, img: 'event_64.jpg', title: 'ミントブルー', category: "stage", class: "吹奏楽部", floor:1, room:"gym_stage", location:"体育館"},
    { id: 65, img: 'event_65.jpg', title: '翠嵐ピアノの会', reading: "すいらんぴあののかい", category: "stage", class: "有志", floor:1, room:"gym_stage", location:"体育館"},
    { id: 66, img: 'event_66.png', title: '弦楽部', reading: "げんがくぶ", category: "stage", class: "弦楽部", floor:1, room:"gym_stage", location:"野外ステージ"},
    { id: 67, img: 'event_67.jpg', title: 'Project Untitled', reading: "ぷろじぇくとあんたいとるど", category: "stage", class: "有志", floor:1, room:"gym_stage", location:"体育館"},
