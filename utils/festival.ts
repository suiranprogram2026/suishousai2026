...
//{ id: 1, img: 'event_1.jpg←数字はidと一致', title: '企画名', reading: "企画名読み方", category: 上参照, floor: 階（マップ用）, class: "団体", room: マップのroomid, location: 開催教室（roomidでmapsvgと連動して、こっちをポップアップに表示する。},
    ...
    { id: 9, img: 'event_9.jpeg', title: 'Our School Kakehiki', category: "play", floor: 3, class: "1-9",location: "1-9", room:"room-1-9"},
    //2年
    ...
    { id: 48, img: 'event_48.jpge', title: '文芸部の足跡', reading: "ぶんげいぶのあしあと", category: "exhibition", floor: 2, class: "文芸部", location:"2階1棟2棟廊下", room:"path-2-1-2-c"},
